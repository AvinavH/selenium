...
public class captureScreen extends SecondPage {
 ...
 FileUtils.copyFile(CaptureImg,new File("C:\\Users\\avina\\eclipse-workspace\\Coursera\\test-output\\ScreenShots\\"+timestamp+"_output.png"));
 }
 ...
 public static String screenCapture(String NegativeScreenshot) throws IOException
	{
		driver.manage().timeouts().implicitlyWait(6, TimeUnit.SECONDS);
		 ...
		 TakesScreenshot ts = (TakesScreenshot)driver;
	        ...
	        String dest = "C:\\Users\\avina\\eclipse-workspace\\Coursera\\test-output\\ErrorScreenshots\\"+NegativeScreenshot+".png";
