...
import com.coursera.Util.ExcelWriter;
...
public class CourseraSecondPageTest extends TestBase {
	ExtentReports extent;
    ExtentTest test;
	HomePage home;
	SecondPage second;
	Logger log = Logger.getLogger("CourseraSecondPageTest");
	public CourseraSecondPageTest()
	{
		super();
	}
	...
	{
		extent = new ExtentReports("C:\\Users\\avina\\eclipse-workspace\\Coursera\\test-output\\CourseraExtentReport.html",false);
		log.info("Brwoser invokation");
		initialization();
	...
	public void verifySecondPageTest()
	{
		...
		log.info("Verify SecondPage Test");
	...
	public void verifyDomainNameTest()
	{
		...
		log.info("Verify Domain Name Test");
	...
	public void skillButtonVisibilityTest()
	{
		...
		log.info("Skill Button Verification Test");
	...
	public void setValidSkillFilterTest()
	{
		...
		log.info("Set Valid Skill Filter Test");
	...
	public void setInvalidSkillsTest1()
	{
		...
		log.info("Set InValid Skill Filter Test: 1");
	...
	public void setInvalidSkillsTest2()
	{
		...
		log.info("Set InValid Skill Filter Test: 2");
		SoftAssert softAssert = new SoftAssert();
	...
	public void setInvalidSkillsTest3()
	{
		...
		log.info("Set InValid Skill Filter Test: 3");
		SoftAssert softAssert = new SoftAssert();
	...
	public void LevelButtonVisibilityTest()
	{
		...
		log.info("Level Button Verification Test");
	...
	public void setLevelFilterTest()
	{
		...
		log.info("Set Level Filter Test");
	...
	public void LanguageButtonVisibilityTest()
	{
		...
		log.info("Language Button Verification Test");
	...
	public void setInvalidLanguageTest1()
	{
		...
		log.info("Set InValid Language Filter Test: 1");
		SoftAssert softAssert = new SoftAssert();
	...
	public void setInvalidLanguageTest2()
	{
		...
		log.info("Set InValid Language Filter Test: 2");
		SoftAssert softAssert = new SoftAssert();
	...
	public void setInvalidLanguageTest3()
	{
		...
		log.info("Set InValid Language Filter Test: 3");
		SoftAssert softAssert = new SoftAssert();
	...
	public void setValidLanguageFilterTest()
	{
		...
		log.info("Set Valid Language Filter Test");
	...
	public void ApplyButtonVisibilityTest()
	{
		...
		log.info("Apply Button Verification Test");
	...
	public void applyFiltersTest()
	{
		...
		log.info("Set Apply Filter Test");
		second.applyFilters();
	...
	public void getFirstCourseInfoTest() throws FileNotFoundException, IOException
	{
		...
		log.info("Get First Course Info Test");
	...
	public void getSecondCourseInfoTest() throws FileNotFoundException, IOException
	{
		...
		log.info("Get Second Course Info Test");
		ExcelWriter write = new ExcelWriter();
		write.courseInfo2();
	...
	{
		log.info("Closing off the browser");
		extent.flush();
        extent.close();
        driver.close();
	}
